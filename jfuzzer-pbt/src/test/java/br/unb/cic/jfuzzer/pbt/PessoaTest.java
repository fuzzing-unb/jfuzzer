...
class PessoaTest {
    ...
    private static final Range<Double> RANGE_MONEY = new Range<Double>(0.0d, 150000.0d);
    private static final Range<Integer> RANGE_SONS = new Range<Integer>(0, 5);
    ...
    void testPessoa() {
        ...
        config.setDoubleLengthRange(RANGE_MONEY);
        config.setIntegerLengthRange(RANGE_SONS);
