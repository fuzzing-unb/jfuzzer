...
public class BlackBoxFuzzer extends StringMutationFuzzer implements JFuzzerObserver {

    //dummy implementation for now
    
    private List<Event> events = new LinkedList<>();
    
    public BlackBoxFuzzer(List<String> seeds, PowerSchedule schedule, int index) {
